        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <header className="h-16 px-8 bg-white/80 backdrop-blur-md border-b border-slate-200/80 sticky top-0 z-20 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link
                href="/notifications"
                className="relative p-2 rounded-xl text-slate-500 bg-slate-50 hover:bg-slate-100 hover:text-slate-900 border border-slate-200/60 shadow-2xs transition-colors"
                title="Notifikasi"
              >
